...
#    Updated: 2025/10/26 14:55:39 by joao-alm         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
HELPER	= atoi_base.c atoi.c free_split.c ft_split.c gnl_util.c gnl.c str_util.c
HELPER	:= $(addprefix src/helper/, $(HELPER))

SRC 	= fdf.c keyhook.c parser.c util.c
